import{r as f,j as e}from"./index-CEUxYXHF.js";import{g as X}from"./index-CH_iu5NA.js";const Y=({algo:j})=>{const[N,T]=f.useState("");f.useEffect(()=>{switch(j){case"FCFS":T(`### 🚀 First-Come, First-Served (FCFS)
